...
public class ImageDownloaderThread extends HandlerThread {
    ...
    //    Using executor to initialize a thread pool to download mutiple images simultaneously.
...
//                To use executor service, adding the same code as in ImageDownloaderSingleThread inside another Runnable
